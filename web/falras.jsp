...
<html>
	<head>
		...
		<title>Re-Allocation | FaLRAS</title>
...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">    
    ...
    <div class="main-content">
        <div class="title">
            <h3 align = 'center'><b>FaLRAS | Faculty Lecture Re-Allocation System</b></h3>
        </div>
        <div class="main">
            <div class="widget">
                <div class="title">
                    <h3 font-color='black', align = 'center'>Enter the Following Details</h3><br>
                    </div>
                <div class="chart">
                    ...
                    <div id="Demo1" class="w3-container w3-hide"></div>
                            <div class="container">
                              ...
                              <div class="row">
                                <div class="col-25">
                                  <label for="lname">LTID</label>
                                </div>
                                <div class="col-75">
                                  <input type="text" id="ltid" name="ltid" placeholder="Enter the teacher lecture id...">
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-25">
